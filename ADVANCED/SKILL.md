...
### Example 7: Deal xong, đối tác mời ăn mừng

**Input:** "Ký deal xong, đối tác mời đi ăn uống. Không đi không được."

**Output:**

```
## 🎯 Tình huống
Deal xong - đối tác mời ăn mừng - HIGH STAKES

## 📖 Script đọc lên
"Dạ em cảm ơn anh/chị ạ. Em đi ạ, nhưng tối nay em limit 1-2 ly thôi vì mai em có cuộc họp sớm. Anh/chị uống thoải mái ạ, em phục vụ."

## 📱 Text gửi
(Đang ngồi thì nói trực tiếp, không cần text)

## ⚖️ Hierarchy Reading
Deal đã ký = đối tác muốn celebrate. Đi = show appreciation. Limit vì công việc mai.

## ⚠️ Health reminder
Deal xong → 1-2 ly thôi. Uống nhiều nước, ăn nhiều. Giữ bàn cho đối tác vui.

## 📌 Damage control
Nếu đối tác ép nhiều → "Dạ em uống hết sức rồi ạ, em nhờ anh/chị nhiều..."
```

### Example 8: Thăng chức, sếp mời ăn mừng

**Input:** "Lên chức rồi, sếp mời đi ăn mừng. Không thể từ chối."

**Output:**

```
## 🎯 Tình huống
Thăng chức - sếp mời ăn mừng

## 📖 Script đọc lên
"Dạ em cảm ơn anh/chị ạ. Em rất vinh dự được anh/chị mời. Em uống 1 ly thôi ạ vì tối nay em phải về sớm. Lần sau em xin phép đặt trước 1 chai riêng ạ."

## 📱 Text gửi
(Đang ngồi thì nói trực tiếp)

## ⚖️ Hierarchy Reading
Thăng chức = sếp recognize mày. Mời ăn = favor. Đi = respect.

## ⚠️ Health reminder
Thăng chức → uống 1-2 ly, giữ tỉnh táo. Không say vì mai còn đi làm.

## 📌 Damage control
Hôm sau gửi tin cảm ơn: "Em cảm ơn anh/chị đã mời ạ. Em rất vinh dự được thăng chức dưới sự dẫn dắt của anh/chị!"
```

### Example 9: Đi ăn cưới, bị ép uống rượu cưới

**Input:** "Đi ăn cưới, khách trong bàn mời rượu cưới. Không uống thì thiếu tôn trọng cô dâu chú rể."

**Output:**

```
## 🎯 Tình huống
Ăn cưới - rượu cưới - tradition pressure

## 📖 Script đọc lên
"Em uống 1 ly cùng cô dâu chú rể ạ. Chúc cô dâu chú rể trăm năm hạnh phúc! Em limit tối nay vì phải lái xe về ạ."

## 📱 Text gửi
(Đang ngồi ăn thì nói trực tiếp)

## ⚖️ Hierarchy Reading
Cưới = tradition. Rượu cưới = symbol. Không uống = có thể bị chê.
Nhưng mày có thể limit 1 ly rồi thank.

## ⚠️ Health reminder
Ăn cưới → rượu mạnh (thường là rượu trắng). 1 ly thôi, uống nhiều nước.

## 📌 Damage control
Nếu bị ép nhiều → "Dạ em cảm ơn, em hết sức rồi ạ. Cô dâu chú rể hạnh phúc nha!"
```